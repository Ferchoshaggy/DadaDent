...
<head>
    ...
    <title>PRESUPUESTO INTERNO</title>
    ...
    <table class="table" style=" width: 100%; text-align: left;border-collapse:collapse; margin-top: 60px;">
        <thead>
            <tr>
               ...
               <th style="width: 100px; text-align: left; font-weight: 0; padding-bottom: 20px;">Costo</th> 
               <th style="text-align: left; font-weight: 0; padding-bottom: 20px;">Descuento</th> 
               <th style="width: 50px; text-align: right; font-weight: 0; padding-bottom: 20px;">Ganancia</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td >
                    ...
                    0%
                    @else
                    {{$presupuesto_procedimiento->descuento}}%
                    @endif
                </td>
                <td >{{round($ganancia, 2)}}</td>
            </tr>
            @endforeach
        </tbody>
